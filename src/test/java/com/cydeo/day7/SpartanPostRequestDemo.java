 ...
 */
    ...
    public void postMethod1(){
        ...
        String requestJsonBody = "{\"gender\":\"Male\",\"name\":\"Bilbo\",\"phone\":9005556878}";
        ...
        assertThat(response.path("data.name"), is("Bilbo"));
        assertThat(response.path("data.gender"), is("Male"));
        assertThat(response.path("data.phone"), is(9005556878L));
    }
    ...
    public void postMethod2(){
        ...
        //create a map to keep request json body informatiion
    ...
    @DisplayName("POST creating Spartan with dynamically")
    @Test
    public void creatingSpartan(){
        Map<String, Object> creatingSpartan = SpartanUtils.creatingSpartan();

        String expectedResponseMessage = "A Spartan is Born!";

        int idFromPost = given().accept(ContentType.JSON)
                .and().contentType(ContentType.JSON)
                .body(creatingSpartan).log().body()
                .when().post("/api/spartans")
                .then().statusCode(201)
                .contentType("application/json")
                .body("success", is(expectedResponseMessage))
