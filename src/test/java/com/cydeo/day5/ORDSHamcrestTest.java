...
public class ORDSHamcrestTest extends HRTestBase {
    ...
    public void employeesTest() {
        ...
        given().accept(ContentType.JSON)
                ...
                .body("items.first_name", equalTo(names)); //equality of lists assertion  // or equalToObject method
    }

    @Test
    public void employeesTest2() {
        //we want to chain and also get response object  // .extract() --> method
        ...
        assertThat(jsonPath.getList("items.first_names"),hasSize(5));
